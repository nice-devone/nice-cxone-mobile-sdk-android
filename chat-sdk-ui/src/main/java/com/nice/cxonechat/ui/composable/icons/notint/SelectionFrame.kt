...
internal val ChatIcons.SelectionFrame: ImageVector
    get() {
        if (_selectionFrame != null) {
            return _selectionFrame!!
        }
        _selectionFrame = Builder(
            ...
            path(
                fill = SolidColor(Color(0xFF254FE6)),
                stroke = null,
...
private var _selectionFrame: ImageVector? = null

@Preview
@Composable
private fun PreviewSelectionFrame() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = ChatIcons.SelectionFrame, contentDescription = "")
    }
}
