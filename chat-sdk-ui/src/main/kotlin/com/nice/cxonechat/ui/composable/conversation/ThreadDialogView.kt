...
import com.nice.cxonechat.ui.R.string.ok
...
private fun InvalidAttachmentsDialog(
    ...
    ChatTheme.ErrorAlertDialog(
        ...
        body = stringResource(
            ...
            dialog.attachments.map { entry ->
                stringResource(string.invalid_attachment_template, entry.value)
            }
        ),
        buttonText = stringResource(id = ok),
