 ...
 * @param onClickLabel Click action accessibility label.
 * @param onLongClick Long click action.
 * @param onLongClickLabel Long click action accessibility label.
 */
@Composable
...
internal fun String?.toPreviewType(thumbnailSize: ThumbnailSize): PreviewType = when {
