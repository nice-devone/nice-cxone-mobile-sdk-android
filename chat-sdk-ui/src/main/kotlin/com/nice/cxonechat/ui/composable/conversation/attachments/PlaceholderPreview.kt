...
internal fun PlaceholderPreview(
    ...
    contentDescription: String? = attachment.mimeType,
) {
    ...
    Icon(
        ...
        contentDescription = stringResource(
            id = string.content_description_attachment_placeholder_view,
            contentDescription ?: stringResource(string.fallback_document_initial_extension)
        ),
        modifier = iconMod,
