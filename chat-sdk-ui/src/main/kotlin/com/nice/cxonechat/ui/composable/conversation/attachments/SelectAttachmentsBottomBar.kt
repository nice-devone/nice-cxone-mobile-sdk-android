        ...
        Crossfade(selecting) { isSelecting ->
            if (isSelecting) {
                Row(
                    ...
                    Row {
                        AllButton(onSelectAll)
                        NoneButton(onSelectNone, selectionNotEmpty)
                    }
...
@Composable
private fun AllButton(onSelectAll: () -> Unit) {
    TextButton(
        onClick = onSelectAll,
...
@Composable
private fun NoneButton(onSelectNone: () -> Unit, selectionNotEmpty: Boolean) {
    TextButton(
...
private fun ShareButton(
    ...
    IconButton(
        ...
        enabled = enabled,
        modifier = modifier,
        colors = IconButtonDefaults.iconButtonColors(contentColor = colorScheme.primary, disabledContentColor = colorScheme.primary),
    ) {
