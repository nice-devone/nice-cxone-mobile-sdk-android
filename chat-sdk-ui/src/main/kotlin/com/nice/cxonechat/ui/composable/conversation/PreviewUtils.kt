...
@Stable
internal fun previewAudioState(initialDuration: Duration = Duration.ZERO): AudioRecordingUiState {
    val isRecordingFlow = MutableStateFlow(true)
    val durationFlow = MutableStateFlow(initialDuration)
...
@Stable
internal fun createPreviewPopup(timeoutSeconds: Long = 20): Popup.InactivityPopup = object : Popup.InactivityPopup {
