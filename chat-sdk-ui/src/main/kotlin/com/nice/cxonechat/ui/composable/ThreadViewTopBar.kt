...
@Composable
internal fun ThreadViewTopBar(isMultiThread: Boolean, isLiveChat: Boolean, scrollBehavior: TopAppBarScrollBehavior?, onBack: () -> Unit) {
    ...
    ChatThreadTopBar(
        ...
        conversationState = ConversationTopBarState(
            ...
            agentName = chatThreadViewModel.agentNameFlow,
            hasAiMessages = chatThreadViewModel.hasAiMessages,
            hasAgent = chatThreadViewModel.hasAgentFlow,
        ),
