...
internal class DefaultTest {
    ...
    @Test
    fun `raw imageUrl key deserializes into filteredFallbackImageUrl while publicImageUrl maps to imageUrl`() {
        val filteredFallbackImageUrl = nextString()
        val expectedAgent = makeAgent().copy(filteredFallbackImageUrl = filteredFallbackImageUrl)
        val agent = object {
            ...
            val imageUrl: String = filteredFallbackImageUrl
