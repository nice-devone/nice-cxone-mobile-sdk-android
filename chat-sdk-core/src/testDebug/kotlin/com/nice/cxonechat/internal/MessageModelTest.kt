...
internal class MessageModelTest {
    ...
    fun testMessageCreatedAtMillisPrecedence() {
        val createdAtMillis = Instant.fromEpochMilliseconds(1000)
        val createdAt = Instant.fromEpochMilliseconds(1)
        ...
        assertNotEquals(createdAt, actual)
        assertEquals(createdAtMillis, actual)
    }
    ...
    fun testMessageCreatedAtFallback() {
        ...
        assertEquals(createdAtMillis, message.createdAt)
    }
}
