...
internal class ChatThreadHandlerMessageReadByAgentTest : AbstractMultiThreadChatTest() {
    ...
    fun read_event_for_message_not_yet_in_thread_adds_message_with_read_status() {
        ...
        val actual = testCallback({ listener: (ChatThread) -> Unit ->
            val job = testScope.launch { emptyThreadHandler.threadFlow.drop(1).collect { listener(it) } }
