...
internal object ServerRequest {
    ...
    fun SetContactCustomFields(
        ...
        .serialize()
        .verifySetContactCustomFields(fields, contactId = thread.contactId.toString())
    ...
    object StoreVisitorEvents {
        fun CustomVisitorEvent(data: String, date: Instant = Instant.fromEpochMilliseconds(0)) =
            VisitorEvent(
