...
internal class EncryptedCookieDataStoreTest {
    ...
    fun loadCookies_includesPersistentCookies() {
        runBlocking {
            ...
            val regularCookie = createCookie(
                ...
                Clock.System.now().toEpochMilliseconds() + TimeUnit.DAYS.toMillis(1)
            )
    ...
    fun loadCookies_currentTimeCalculationIsAccurate() {
        runBlocking {
            val url = "https://example.com/".toHttpUrl()
            val expiresAtTime = Clock.System.now().toEpochMilliseconds() + TimeUnit.SECONDS.toMillis(100)
    ...
    private fun createCookie(
        ...
        value: String,
        domain: String,
        expiresAt: Long = Clock.System.now().toEpochMilliseconds() + TimeUnit.DAYS.toMillis(1),
        path: String = "/",
