...
private val linearTime = generateSequence(Instant.fromEpochMilliseconds(Clock.System.now().toEpochMilliseconds())) { it + 1.milliseconds }.iterator()
...
internal fun makeMessageModel(
    ...
    createdAt: Instant = linearTime.next(),
