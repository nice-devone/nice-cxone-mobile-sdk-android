...
internal class ChatThreadMessageHandlerImpl(
...
) : ChatThreadMessageHandler, LoggerScope by LoggerScope("ChatThreadMessageHandlerImpl", parentScope) {

    override fun loadMore(): Unit = scope("loadMore") {
        chat.entrails.threading.coroutineScope.safeLaunch(childScope("triggerLoadMoreMessages")) {
    ...
    override suspend fun send(message: OutboundMessage): String {
        ...
        return event.messageId.toString()
    }
