...
import com.nice.cxonechat.util.truncateToSeconds
...
internal data class ActionLoadMoreMessages(
    ...
    constructor(
        ...
        payload = Payload(
            ...
            data = Data(
                ...
                oldestMessageDatetime = thread.messages.last().createdAt.truncateToSeconds(),
            )
        )
    )
    ...
    data class Data(
        ...
        @Contextual
        val oldestMessageDatetime: Instant,
    )
}
