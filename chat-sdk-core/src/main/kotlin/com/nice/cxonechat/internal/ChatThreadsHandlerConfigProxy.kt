...
internal class ChatThreadsHandlerConfigProxy(
    ...
    @Volatile private var threadCount: Int = -1

    override val threadsFlow: Flow<List<ChatThread>> = origin.threadsFlow.onEach { threads ->
        // Closed/archived threads (canAddMoreMessages=false) must not block creating a new thread.
        threadCount = threads.count { it.canAddMoreMessages }
    }
