...
) : ChatThreadHandler by origin, LoggerScope by LoggerScope("ChatThreadHandlerMulti", chat.entrails.logger) {
    override suspend fun archive(): Boolean {
        ...
        try {
            ...
            warning("Failed to trigger archive event for thread", logged)
            complete(success = false)
        }
