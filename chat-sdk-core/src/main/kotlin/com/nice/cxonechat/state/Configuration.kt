...
interface Configuration {
     ...
     *
     * Secured sessions are becoming mandatory for all channels. This flag will be removed in a
     * future SDK release. The SDK will treat secured sessions as always enabled regardless of
     * this value; integrators no longer need to consult it.
     */
    @Deprecated(
        message = "Secured sessions are becoming mandatory; this flag will be removed in a future release.",
    ...
    enum class Feature(internal val key: String) {
         ...
         *
         * Secured sessions are becoming mandatory; this feature flag will be removed in a future release.
         */
        @Deprecated(
            message = "Secured sessions are becoming mandatory; this feature flag will be removed in a future release.",
            level = DeprecationLevel.WARNING,
        )
