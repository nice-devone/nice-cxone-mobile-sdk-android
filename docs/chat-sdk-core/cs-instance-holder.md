...
For more detailed information, refer to the [implementation.md](../implementation.md) document which explains the differences between
`ChatInstanceProvider` and `ChatBuilder`.
