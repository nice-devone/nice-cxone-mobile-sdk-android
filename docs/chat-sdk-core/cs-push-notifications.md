...
> If you are using the UI module, then the Service part the use-case is already covered by the UI module and the case study
...
```kotlin
internal class PushListenerService : com.google.firebase.messaging.FirebaseMessagingService() {
