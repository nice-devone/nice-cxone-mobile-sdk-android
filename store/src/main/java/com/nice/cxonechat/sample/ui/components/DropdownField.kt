...
fun <KeyType> DropdownField(
    ...
    Row(
        ...
        modifier = Modifier
            .testTag(if (label.isNotEmpty()) "dropdown_field_$label" else "dropdown_field")
            .then(modifier)
        ...
        Box {
            ...
            DropdownMenu(
                ...
                options.forEach { item ->
                    DropdownFieldItem(expanded, onSelect, item, value)
                }
            }
        }
    }
...
@Composable
private fun <KeyType> DropdownFieldItem(
    expanded: MutableState<Boolean>,
    onSelect: (KeyType) -> Unit,
    item: DropdownItem<KeyType>,
    value: KeyType?,
) {
    DropdownMenuItem(
        onClick = {
...
@Composable
private fun Placeholder(placeholder: String) {
    DropdownMenuItem(
        onClick = { },
        text = { Text(placeholder) },
        modifier = Modifier.testTag("placeholder_item")
    )
    HorizontalDivider()
}
