 ...
 * @param connectionToken saved JWT token from implicit OAuth flow.
 * @param connectionTokenExpiry expiry of [connectionToken] as Unix epoch millis.
 * @param authStateJson JSON-serialized AppAuth [net.openid.appauth.AuthState] used for silent
 *   token refresh via [net.openid.appauth.AuthState.performActionWithFreshTokens].
 */
@Serializable
data class ChatSettings(
    ...
    val connectionTokenExpiry: Long? = null,
