 ...
 *
 * @param dataSource Local product data source backed by a pre-bundled asset file.
...
class StoreRepository(
     ...
     *
     * @param category Category to fetch (currently "smartphones" is supported).
        ...
        return@withContext if (cached?.first == category) {
            ...
            runCatching {
                ...
                allProducts
                    ...
                    .sortedBy(Product::title)
                    .also { products -> productsCache.value = category to products }
            }
        }
    }
    ...
    suspend fun getProduct(
        ...
        productsCache.value?.second
            ...
            ?: runCatching {
                dataSource.loadProducts().firstOrNull { it.id == productId }
